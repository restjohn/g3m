...
public abstract class IStringUtils {
  ...
  public static void setInstance(final IStringUtils instance) {
    if (_instance != null) {
      ILogger.instance().logWarning(
          "Warning, IStringUtils instance set two times\n");
    }
    _instance = instance;
  }
  ...
  // Java:
  // ORIGINAL LINE: virtual String createString(byte data[], int length)
  // const = 0;
  public abstract String createString(byte[] data,
                                      int length);


  // C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in
  // Java:
  // ORIGINAL LINE: virtual java.util.ArrayList<String> splitLines(const
  ...
  // C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in
  // Java:
  // ORIGINAL LINE: virtual boolean beginsWith(const String& String, const
  // String& prefix) const = 0;
  public abstract boolean beginsWith(String String,
                                     String prefix);


  // C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in
  // Java:
  // ORIGINAL LINE: virtual int indexOf(const String& String, const String&
  // search) const = 0;
  ...
  // beginIndex, int endIndex) const = 0;
  public abstract String substring(String String,
                                   int beginIndex,
                                   int endIndex);
  ...
  // C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in
  // Java:
  // ORIGINAL LINE: virtual String replaceSubstring(const String&
  // originalString, const String& toReplace, const String& replaceWith)
  // const
  public String replaceSubstring(final String originalString,
  ...
  // C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in
  // Java:
  // ORIGINAL LINE: virtual String left(const String& String, int endIndex)
  // const
