...
public class GPlanarPanoramicViewer {
   ...
   //
   //
   //      private final java.awt.Rectangle        _pixelsBounds;
   //
   //
   ...
   //         tryToLoadImage();
   //         final java.awt.Rectangle bounds = calculateBounds();
   //         //setBounds(calculateBounds());
   //         setHeight(Integer.toString(bounds.height) + "px");
   //         setWidth(Integer.toString(bounds.width) + "px");
   //      }
   //
   //
